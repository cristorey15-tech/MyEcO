...
export function Modal({ isOpen, onClose, title, children, size = 'md', footer }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      />
      <div className={cn(
        'relative bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full animate-scale-in overflow-hidden',
        sizes[size]
      )}>
        ...
        {footer && (
          <div className="px-6 py-4 border-t border-gray-100 dark:border-gray-700/50 bg-gray-50/50 dark:bg-gray-700/50 flex justify-end gap-3">
            {footer}
          </div>
        )}
      </div>
